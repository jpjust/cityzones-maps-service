% cityzones-maps-service(SECTION) | User Commands
%
% "March  1 2023"
...
cityzones-maps-service - program to do something

# SYNOPSIS

**cityzones-maps-service** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**cityzones-maps-service** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **cityzones-maps-service** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**cityzones-maps-service** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    cityzones-maps-service. See **foo.conf**(5) for further details.
...
**cityzones-maps-service** provides some return codes, that can be used in scripts:
...
João Paulo Just Peixoto <just1982@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 João Paulo Just Peixoto
